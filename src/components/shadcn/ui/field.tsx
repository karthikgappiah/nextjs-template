...
function Field({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: could <fieldset> replace <div>?
    <div
      role="group"
      data-slot="field"
  ...
  const content = useMemo(() => {
    ...
    return (
      <ul className="ml-4 flex list-disc flex-col gap-1">
        {uniqueErrors.map(
          (error, index) =>
            // biome-ignore lint/suspicious/noArrayIndexKey: shadcn default, but bad practice so need to refactor key.
